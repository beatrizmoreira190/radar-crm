  ...
  const row=(item)=><div className="publisher-related-row" key={item.publisher_id}>
    <div className="publisher-related-main">
      ...
      <div className="publisher-related-meta">
        ...
        {item.stage_name&&<span>Etapa: {item.stage_name}</span>}
