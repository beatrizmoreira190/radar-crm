...
export default function PublishersPage(){
  ...
  async function load(){
    ...
    let query=supabase.from('publishers').select('id,name,trade_name,cnpj,city,state,priority,score,stage_id,owner_user_id,prospector_user_id,last_contact_at,next_action_at,commercial_temperature,editorial_profile,editorial_profile_status',{count:'exact'}).eq('organization_id',org).eq('archived',false);
