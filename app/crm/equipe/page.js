...
export default function TeamPage(){
  ...
  if(!isManager)return <div className="page-wrap"><div className="card panel"><h2>Acesso restrito</h2><p className="muted">A gestão da equipe é visível para supervisores e administradores.</p></div></div>;
  return <div className="page-wrap"><div className="page-head"><div><div className="eyebrow">Pessoas e acessos</div><h1>Equipe</h1><p>Veja os perfis disponíveis, gerencie quem já faz parte da equipe e libere novos cadastros.</p></div></div>{notice&&<div className="notice-bar"><span>{notice}</span><button onClick={()=>setNotice('')}><X size={15}/></button></div>}
