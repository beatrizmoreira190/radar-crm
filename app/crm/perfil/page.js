...
export default function ProfilePage(){
  ...
  return <div className="page-wrap narrow">
    ...
    {showCalendar&&<section className="card panel" style={{marginTop:16}}>
      <div className="section-title"><div><div className="eyebrow">Integrações</div><h2 style={{margin:'4px 0'}}>Google Agenda</h2><p className="muted">Agenda conectada ao CRM para consulta de disponibilidade e sincronização de reuniões.</p></div><CalendarDays size={24}/></div>
