...
export default function PipelinePage(){
  ...
  return <div className="page-wrap"><div className="page-head"><div><div className="eyebrow">Funil comercial</div><h1>Pipeline</h1><p>Escolha uma etapa para focar nas editoras daquele status. Todos os estágios ficam visíveis sem rolagem horizontal.</p></div></div>{notice&&<div className="notice-bar"><span>{notice}</span><button onClick={()=>setNotice('')}><X size={15}/></button></div>}
