...
export default function PrioritiesPage(){
  ...
  return <div className="page-wrap">
    <div className="page-head"><div><div className="eyebrow">Execução inteligente</div><h1>Prioridades</h1><p>Veja quais editoras precisam da sua atenção agora. O Radar Score prioriza aderência aos serviços da Radar.</p></div><button className="btn secondary" onClick={load}><RefreshCw size={16}/> Atualizar fila</button></div>
