...
export default function PrioritiesPage(){
  ...
  return <div className="page-wrap">
    <div className="page-head"><div><div className="eyebrow">Execução inteligente</div><h1>Prioridades</h1><p>Uma fila calculada por regras do CRM para responder: em qual editora devo mexer agora e qual é o próximo passo?</p></div><button className="btn secondary" onClick={load}><RefreshCw size={16}/> Atualizar fila</button></div>
    ...
    <section className="card panel"><div className="panel-head"><div><h2>O que fazer agora</h2><p>A fila combina prazo, responsabilidade, histórico e Radar Score. Não usa IA.</p></div><ListChecks size={21}/></div>
