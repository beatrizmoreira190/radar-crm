...
export const EDITORIAL_PROFILE_OPTIONS = [
  'Acadêmico/Científico','Acupuntura','Autoconhecimento','Bilíngue/Idiomas','Desenvolvimento pessoal','Didático','Discipulado','Educação','Educação infantil','Enfermagem','Engenharia','Espiritualidade','Espiritualidade/Espiritismo','Família','Fantasia','Ficção científica','Folclore','Graphic novel','História/Humanidades','Infantil','Infantojuvenil','Literatura','Literatura brasileira','Medicina','Medicina chinesa','Negócios/Administração','Não ficção','Nutrição','Odontologia','Paradidático','Pediatria','Poesia','Psicologia','Quadrinhos/HQ','Religioso','Religioso/Cristão','Romance','RPG/Jogos','Saúde','Tecnologia','Teologia','Terror/Horror','Veterinária'
];
